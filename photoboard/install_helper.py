from backend import boards,users,photos
...
print u.init_table('CREATE TABLE if not exists users (id integer primary key, username varchar unique, timestamp timestamp);')
